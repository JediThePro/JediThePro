!(function (a) {
  ...
  (function (a) {
    ...
    function c(a) {
      var b;
      return a.value === a.getAttribute(G) && "true" === a.getAttribute(H)
        ? (a.setAttribute(H, "false"),
          (a.value = ""),
    ...
    function e(a, b) {
      ...
      if (a && a.getAttribute(G)) b(a);
        ...
        for (
          c = a ? a.getElementsByTagName("input") : o,
    ...
    function h(a) {
      return function () {
        q && a.value === a.getAttribute(G) && "true" === a.getAttribute(H)
          ? R.moveCaret(a, 0)
          : c(a);
      };
    }
    ...
    function j(a) {
      return function (b) {
        return (
          (s = a.value),
          "true" === a.getAttribute(H) &&
          s === a.getAttribute(G) &&
          R.inArray(C, b.keyCode)
    ...
    function n(a) {
      a.form &&
        ((x = a.form),
        x.getAttribute(J) ||
          (R.addEventListener(x, "submit", m(x)), x.setAttribute(J, "true"))),
        R.addEventListener(a, "focus", h(a)),
        R.addEventListener(a, "blur", i(a)),
        q &&
          (R.addEventListener(a, "keydown", j(a)),
