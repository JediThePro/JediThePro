  ...
  d.flexslider = function (j, l) {
    ...
    f = {
        ...
        setupPaging: function () {
          ...
          if (1 < a.pagingCount)
            for (var p = 0; p < a.pagingCount; p++)
              (g =
                "thumbnails" === c.controlNav
                  ? '<img src="' + a.slides.eq(p).attr("data-thumb") + '"/>'
                  : "<a>" + b + "</a>"),
      ...
      touch: function () {
        function b(b) {
          ...
          q = m
            ? Math.abs(k) < Math.abs(b.touches[0].pageX - e)
            : Math.abs(k) < Math.abs(b.touches[0].pageY - e);
          if (!q || 500 < Number(new Date()) - l)
            b.preventDefault(),
              !s &&
                ...
                (c.animationLoop ||
                  (k /=
                    (0 === a.currentSlide && 0 > k) ||
                    (a.currentSlide === a.last && 0 < k)
                      ? Math.abs(k) / r + 2
                      : 1),
                a.setProps(f + k, "setTouch"));
        }
        function g() {
          ...
          if (a.animatingTo === a.currentSlide && !q && null !== k) {
            ...
            a.canAdvance(m) &&
            ((550 > Number(new Date()) - l && 50 < Math.abs(h)) ||
              Math.abs(h) > r / 2)
              ? a.flexAnimate(m, c.pauseOnAction)
              : s || a.flexAnimate(a.currentSlide, c.pauseOnAction, !0);
          }
    ...
    a.setProps = function (b, g, d) {
      ...
      e =
        ...
        "px";
      a.transitions &&
        ((e = m ? "translate3d(0," + e + ",0)" : "translate3d(" + e + ",0,0)"),
    ...
    a.setup = function (b) {
      if (s)
        ...
        "init" === b &&
          ...
          (a.cloneOffset = 0),
          n &&
            ((p = d.makeArray(a.slides).reverse()),
            (a.slides = d(p)),
            a.container.empty().append(a.slides)));
        c.animationLoop &&
          !h &&
  ...
  d.fn.flexslider = function (j) {
    ...
    if ("object" === typeof j)
      return this.each(function () {
        ...
        1 === c.length
          ? (c.fadeIn(400), j.start && j.start(a))
